 ...
 * 
 * Type definitions for LexFiat entities used by client code.
 * These types mirror the database schema but contain NO runtime imports.
 * 
 * Note: Timestamps can be either string (ISO format) or Date objects,
 * depending on whether they come from JSON or have been parsed.
 */
...
// Insert types for client-side form validation and creation
