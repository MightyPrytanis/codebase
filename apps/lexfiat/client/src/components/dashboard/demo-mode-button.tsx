...
export function DemoModeButton() {
  ...
  const loadDemo = useMutation({
    mutationFn: async (scenarioId: string) => {
      // Use the demo service to load mock pleadings
      const { loadDemoScenario } = await import("@/lib/demo-service");
      return loadDemoScenario(scenarioId);
    },
    onSuccess: (data) => {
  ...
  const clearDemo = useMutation({
    mutationFn: async () => {
      // Use the demo service to clear demo data
      const { clearDemoData } = await import("@/lib/demo-service");
      clearDemoData();
      return { success: true };
    },
    onSuccess: () => {
