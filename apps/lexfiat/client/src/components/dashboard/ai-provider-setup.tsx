...
export function AiProviderSetup() {
  ...
  const availableProviders = [
    { key: "provider-1", name: "AI Provider A", icon: "🔍", description: "Research-focused AI with real-time web access" },
    { key: "provider-2", name: "AI Provider B", icon: "🧠", description: "Advanced reasoning and analysis capabilities" },
    { key: "provider-3", name: "AI Provider C", icon: "🤖", description: "General-purpose AI models" },
    { key: "provider-4", name: "AI Provider D", icon: "💎", description: "Multimodal AI with document analysis" },
    { key: "provider-5", name: "AI Provider E", icon: "🔥", description: "Conversational AI with real-time information" },
    { key: "provider-6", name: "AI Provider F", icon: "🧮", description: "Advanced AI models for reasoning and coding" },
    { key: "provider-7", name: "AI Provider G", icon: "🍁", description: "Specialized AI with focus on reasoning" },
  ];
