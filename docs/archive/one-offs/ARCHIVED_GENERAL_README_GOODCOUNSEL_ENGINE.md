---
Document ID: ARCHIVED-GENERAL_README_GOODCOUNSEL_ENGINE
Title: General Readme Goodcounsel Engine
Subject(s): Archived | Redundant
Project: Cyrano
Version: v548
Created: Unknown
...
Summary: Redundant document archived. Duplicate of Cyrano/src/engines/goodcounsel/README.md
Status: Archived
---

**ARCHIVED:** This document is redundant and has been archived. Duplicate of Cyrano/src/engines/goodcounsel/README.md Archived 2025-11-28.
...
- **Services:**
  ...
  - `ethics-rules-engine` - Rule-based ethics compliance evaluation
...
This is v1 of a feature that will receive additional attention and may be rebranded as capabilities expand beyond the legal domain.
