---
Document ID: ARCHIVED-ARKIVER_UI_SOURCE_OF_TRUTH
Title: Arkiver Ui Source Of Truth
...
Summary: Redundant document archived. Root-level duplicate of docs/ui/ARKIVER_UI_SPECIFICATION.md
Status: Archived
---

**ARCHIVED:** This document is redundant and has been archived. Root-level duplicate of docs/ui/ARKIVER_UI_SPECIFICATION.md Archived 2025-11-28.
...
Owner: David W Towne / Cognisint LLC
Copyright: © 2025 Cognisint LLC
Summary: Definitive reference for all Arkiver UI structure, styling, and behavior. Authoritative specification that all UI implementations must match.
Status: Active
