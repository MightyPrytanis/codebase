...
Title: GoodCounsel: Philosophy and Design Intent
Subject(s): UI | GoodCounsel | Design | Philosophy
Project: Cyrano
Version: v548
...
Summary: Design philosophy, UI/UX principles, and the "why" behind GoodCounsel. For technical implementation and API reference, see Cyrano/src/engines/goodcounsel/README.md
Status: Active
Related Documents: GOODCOUNSEL-ENGINE-README
---

# GoodCounsel: Philosophy and Design Intent

> **Note:** For technical implementation, workflows, and API reference, see [`Cyrano/src/engines/goodcounsel/README.md`](../../Cyrano/src/engines/goodcounsel/README.md)
...
In a system designed to manage the relentless demands of legal practice, GoodCounsel, the heart and soul of LexFiat, says:
