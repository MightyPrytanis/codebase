...
/**
 * LexFiat Database Schema (Drizzle ORM) - Server Runtime
 * 
 * This file contains the server-side Drizzle schema with runtime dependencies.
 * For client-side type definitions, see packages/shared/types/lexfiat-types.ts
 */
