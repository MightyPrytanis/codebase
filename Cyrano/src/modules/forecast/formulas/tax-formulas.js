 ...
 */
export function calculateTaxFromBrackets(taxableIncome, brackets) {
    let tax = 0;
 ...
 */
export function calculateSelfEmploymentTax(selfEmploymentIncome, wages, year) {
    ...
    const socialSecurityWageBaseByYear = {
        2018: 128400,
        2019: 132900,
        2020: 137700,
        2021: 142800,
...
const ACTC_REFUNDABLE_PER_CHILD = {
...
const ACTC_REFUNDABLE_CHILD_LIMIT = 3;
const EITC_MAX_CREDIT = {
 ...
 */
export function calculateFederal(input) {
    const warnings = [];
